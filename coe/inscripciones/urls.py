...
urlpatterns = [
    ...
    path('mod/peticion_persona/<int:peticionp_id>', views.peticion_persona, name='mod_peticion_persona'),
    path('cargar/cargar_people/<int:peticionp_id>', views.cargar_people, name='cargar_people'),
    path('finalizar/peticion/<int:peticionp_id>', views.finalizar_peticion, name='finalizar_peticion'),
    path('peticion/del/<int:peticionp_id>', views.eliminar_peticion, name='eliminar_peticion'),
    path('peticion/<str:token>', views.ver_peticion_persona, name='ver_peticion_persona'),
    path('mod/people/<int:peticionp_id>/<int:individuo_id>', views.cargar_people, name='mod_people'),
    path('peticion/del/persona/<int:peticionp_id>/<int:individuo_id>', views.quitar_persona, name='quitar_persona'),
    path('peticion/enviar_email/<int:peticionp_id>', views.peticion_enviar_email, name='peticion_enviar_email'),
    #COCA ORGANIZACIÓN
