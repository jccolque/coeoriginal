...
urlpatterns = [
    ...
    path('auditar/vigilados', views.auditar_controlados, name='auditar_controlados'),
    path('carentes', views.carentes_seguimiento, name='carentes_seguimiento'),
    #Panel
    ...
    path('auditar/vigilados/<int:vigia_id>', views.auditar_controlados, name='auditar_controlados'),
    #Gis
    ...
    path('muestras/existe/<int:individuo_id>/<str:num_doc>/', views.cargar_muestra, name='existe_plp'),
    path('muestras/cargar/<str:num_doc>/', views.cargar_muestra, name='cargar_muestra'),
    path('muestras/editar/panel/<int:muestra_id>', views.editar_muestra, name="editar_muestra"),
    path('muestras/editar/panel/<int:muestra_id>', views.cargar_muestra, name="editar_plp"),
