...
void backgroundFetchHeadlessTask(String taskId) async {
  ...
  print('2222222*************** esta enviando datos!!!');
...
//    });
  ...
  Widget buildCron(BuildContext context) {
  ...
  Future<String> apiRequest() async {
    ...
    final item = {
      ...
      "latitud": locations.location.latitude,
      "longitud": locations.location.longitude
    };
